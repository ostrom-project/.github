...
| [`ostrom-cockpit`](https://github.com/ostrom-project/ostrom/tree/main/crates/ostrom-cockpit) | **Atalaya** (web) | The web oversight surface (Dioxus/WASM) | Deferred (no consumer; the TUI is the cockpit) |
