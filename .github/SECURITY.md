...
In scope: the hubs, daemons, CLI, plugins, and the wire protocol as implemented in this organization's repositories. Out of scope: attacks requiring an already-compromised trusted key at full trust tier (that is the design's stated residual risk; report it anyway if you find a way to escalate it).
